...
import {PRODUCTS_PRICE_COLUMNS} from '../../modules/apps/reports/products/ProductRemains/Columns'
import {IProductPrice} from '../../modules/apps/reports/products/models/remains_model'
