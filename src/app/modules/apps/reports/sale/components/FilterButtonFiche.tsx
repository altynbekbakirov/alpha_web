...
export const FilterButtonFiche = () => {
  const intl = useIntl()
  const [date1, setDate1] = useState<Date>()
  const [date2, setDate2] = useState<Date>()
  const [clientFilter, setClientFilter] = useState('')
  const [operationType, setOperationType] = useState('2, 3, 7, 8')
  ...
  useEffect(() => {
    ...
    async function fetchProducts() {
      ...
      setSaleFicheItems(response.data)
    }
  }, [setSaleFicheItems])
      ...
      <div className='menu menu-sub menu-sub-dropdown w-300px w-md-325px' data-kt-menu='true'>
        ...
        <div className='px-7 py-5' data-kt-user-table-filter='form'>
          ...
          <div className='mb-10'>
            ...
            >
              <option value='2, 3, 7, 8'>{intl.formatMessage({id: 'OPERATION_TYPE_ALL'})}</option>
              <option value='7, 8'>{intl.formatMessage({id: 'OPERATION_TYPE_RETAIL_SALE'})}</option>
              <option value='2, 3'>
                {intl.formatMessage({id: 'OPERATION_TYPE_RETAIL_RETURN'})}
              </option>
            </select>
          </div>
          {/* end::Input group */}
