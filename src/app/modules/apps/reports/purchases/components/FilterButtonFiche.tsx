...
export const FilterButtonFiche = () => {
  ...
  useEffect(() => {
    ...
    async function fetchProducts() {
      ...
      setPurchaseFicheItems(response.data)
    }
  }, [setPurchaseFicheItems])
      ...
      <div className='menu menu-sub menu-sub-dropdown w-300px w-md-325px' data-kt-menu='true'>
        ...
        <div className='px-7 py-5' data-kt-user-table-filter='form'>
          ...
          <div className='mb-10'>
            ...
            >
              <option value='1, 6'>{intl.formatMessage({id: 'OPERATION_TYPE_ALL'})}</option>
              <option value='1'>{intl.formatMessage({id: 'OPERATION_TYPE_PURCHASE'})}</option>
              <option value='6'>{intl.formatMessage({id: 'OPERATION_TYPE_RETAIL_RETURN'})}</option>
            </select>
          </div>
          {/* end::Input group */}
