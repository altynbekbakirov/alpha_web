...
import { ISaleFiches } from '../../../../app/modules/apps/reports/sale/models/sale_model'
import { SALES_FICHES_COLUMNS } from '../../../../app/modules/apps/reports/sale/types/Columns'
...
const FichesList: React.FC<IProps> = ({show, setShow, item}) => {
  const intl = useIntl()
  const [items, setItems] = useState<ISaleFiches[]>([])
  const columns = useMemo(() => SALES_FICHES_COLUMNS, [])
  ...
  useEffect(() => {
    ...
    const REQUEST_URL = `${BASE_URL}/sales/client/${item}`
