...
import {IFiche} from '../../../../app/modules/apps/reports/products/models/products_model'
import {PRODUCTS_FICHE} from '../../../../app/modules/apps/reports/products/types/Columns'
...
const FicheContents: React.FC<IProps> = ({show, setShow, item}) => {
  const intl = useIntl()
  const [items, setItems] = useState<IFiche[]>([])
  const columns = useMemo(() => PRODUCTS_FICHE, [])
  ...
  useEffect(() => {
    ...
    const REQUEST_URL = `${BASE_URL}/products/fiche/${item}`
