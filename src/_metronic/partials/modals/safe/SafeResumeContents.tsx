...
import { SAFES_RESUME_COLUMNS } from '../../../../app/modules/apps/reports/safes/types/Columns'
...
const SafeResumeContents: React.FC<IProps> = ({show, setShow, item}) => {
  const intl = useIntl()
  const [items, setItems] = useState<ISafeResume[]>([])
  const columns = useMemo(() => SAFES_RESUME_COLUMNS, [])
  ...
  useEffect(() => {
    ...
    const REQUEST_URL = `${BASE_URL}/safes/${item}`
        ...
        <div className='modal-content shadow-none'>
          <div className='modal-header'>
            <h5 className='modal-title'>
              {intl.formatMessage({id: 'SAFE_RESUME'})}
            </h5>
            <div
...
export default SafeResumeContents
